            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 w-full text-center flex flex-col items-center">
                ...
                <div className="mt-20 sm:mt-28 mb-8 sm:mb-12 w-full flex flex-col items-center justify-center relative reveal z-50">
                    ...
                    <div className="mt-8 sm:mt-10 relative z-20 w-auto">
                        <Link href="#oferta" className="w-full sm:w-auto px-8 py-3.5 text-sm sm:text-base bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-xl shadow-[0_0_15px_rgba(249,115,22,0.4)] hover:shadow-[0_0_25px_rgba(249,115,22,0.6)] transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 group cursor-pointer border border-orange-500/50 backdrop-blur-sm">
